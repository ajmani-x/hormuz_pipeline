...
def render_report(rec) -> str:
    ...
    lines.append("")
    lines.append("=" * 78)
    lines.append("NOTE: all inputs are synthetic/illustrative. This is a mechanics demo,")
    lines.append("not a live risk assessment. See README.md before using with real data.")
    lines.append("=" * 78)
    return "\n".join(lines)
